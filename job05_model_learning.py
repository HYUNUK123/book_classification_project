...
X_train, X_test, Y_train, Y_test = np.load(
    './models/book_data_max_996_wordsize_72589.npy', allow_pickle=True
)
...
# 의미 공간상의 벡터화
model.add(Embedding(72589, 300, input_length=996))
# 문장은 1줄 -> 1차원
...
model.save('./models/book_titles_classification_model_{}.h5'.format(fit_hist.history['val_accuracy'][-1]))
